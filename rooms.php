...
<html lang="en">
	...
	<body>
				...
				<div class="row no-gutters">
					...
					<div class="col-lg-6">
						<div class="room-wrap d-md-flex">
							...
							></a>
							<div
								class="half right-arrow d-flex align-items-center"
							>
								<div class="text p-4 p-xl-5 text-center">
									<p class="star mb-0">
										<span class="fa fa-star"></span
		...
		<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo MAPS_API_KEY; ?>&sensor=false"></script>
